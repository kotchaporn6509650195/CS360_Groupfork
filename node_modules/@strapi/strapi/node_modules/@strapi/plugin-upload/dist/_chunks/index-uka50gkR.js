...
const dependencies = {
  ...
  "@strapi/icons": "1.19.0",
  "@strapi/provider-upload-local": "4.25.13",
...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      async Component() {
        const component = await Promise.resolve().then(() => require("./index-_Pi4tHyp.js"));
        return component;
      }
    });
  ...
  bootstrap(app) {
    app.addSettingsLink("global", {
      ...
      async Component() {
        const component = await Promise.resolve().then(() => require("./index-gJHGg6WN.js"));
        return component;
      },
...
//# sourceMappingURL=index-uka50gkR.js.map
