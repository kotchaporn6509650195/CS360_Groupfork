...
const ListView$1 = lazy(() => import("./ListView-wxHTbrWa.mjs"));
const RecursivePath = () => {
...
const ListView = lazy(() => import("./ListView-wxHTbrWa.mjs"));
const App = () => {
  const { formatMessage } = useIntl();
...
//# sourceMappingURL=index-d4lyU6uk.mjs.map
