...
const AuthenticatedApp = require("./AuthenticatedApp-UI_tEhAn.js");
...
const useSettingsMenu = () => {
  ...
  const { admin: adminLinks, global: globalLinks } = index.useEnterprise(
    ceLinks,
    async () => (await Promise.resolve().then(() => require("./constants-OeNXdbbb.js"))).SETTINGS_LINKS_EE(),
    {
...
const ROUTES_CE = [
  {
    async Component() {
      const { ProtectedListPage } = await Promise.resolve().then(() => require("./ListPage-zwhys6VK.js"));
  ...
  {
    async Component() {
      const { ProtectedCreatePage } = await Promise.resolve().then(() => require("./CreatePage-Fu-YBoSi.js"));
  ...
  {
    async Component() {
      const { ProtectedEditPage } = await Promise.resolve().then(() => require("./EditPage-diqpzIU4.js"));
  ...
  {
    async Component() {
      const { ProtectedListPage } = await Promise.resolve().then(() => require("./ListPage-yk4Befp1.js"));
      return ProtectedListPage;
    },
    to: "/settings/users",
    exact: true
  ...
  {
    async Component() {
      const { ProtectedEditPage } = await Promise.resolve().then(() => require("./EditPage-ANI8JzBa.js"));
      return ProtectedEditPage;
    },
  ...
  {
    async Component() {
      const { ProtectedCreatePage } = await Promise.resolve().then(() => require("./CreatePage-55V7sI0x.js"));
      return ProtectedCreatePage;
    },
  ...
  {
    async Component() {
      const { ProtectedEditPage } = await Promise.resolve().then(() => require("./EditPage-mM5IqM5p.js")).then((n) => n.EditPage$1);
      return ProtectedEditPage;
    },
  ...
  {
    async Component() {
      const { ProtectedListPage } = await Promise.resolve().then(() => require("./ListPage-UcIjqjqz.js"));
      return ProtectedListPage;
    },
  ...
  {
    async Component() {
      const { ProtectedListView } = await Promise.resolve().then(() => require("./ListView-SaPlO8Lg.js"));
  ...
  {
    async Component() {
      const { ProtectedCreateView } = await Promise.resolve().then(() => require("./CreateView-FmyH5_Xb.js"));
  ...
  {
    async Component() {
      const { ProtectedEditView } = await Promise.resolve().then(() => require("./EditViewPage-7bkBrjaI.js"));
  ...
  {
    async Component() {
      const { ProtectedCreateView } = await Promise.resolve().then(() => require("./CreateView-a8xPDcj1.js"));
      return ProtectedCreateView;
    },
  ...
  {
    async Component() {
      const { ProtectedListView } = await Promise.resolve().then(() => require("./ListView-_eoGuSN5.js"));
      return ProtectedListView;
    },
  ...
  {
    async Component() {
      const { ProtectedEditView } = await Promise.resolve().then(() => require("./EditView-OLwRak-v.js"));
      return ProtectedEditView;
    },
...
const ApplicationInfoPage = () => {
  ...
  const AdminSeatInfo = index.useEnterprise(
    AdminSeatInfoCE,
    async () => (await Promise.resolve().then(() => require("./AdminSeatInfo-9o2vpWE8.js"))).AdminSeatInfoEE
  );
  const {
...
const SettingsPage = () => {
  ...
  const routes = index.useEnterprise(
    ROUTES_CE,
    async () => (await Promise.resolve().then(() => require("./constants-S0vc7ZjH.js"))).ROUTES_EE,
    {
...
//# sourceMappingURL=SettingsPage-7v66mkFi.js.map
