...
const useWebhooks = require("./useWebhooks-qv8GjTmi.js");
...
const WebhookForm = ({
  ...
  const EventTable = index.useEnterprise(
    EventTableCE,
    async () => (await Promise.resolve().then(() => require("./EventsTable-IY9fmv-6.js"))).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-mM5IqM5p.js.map
