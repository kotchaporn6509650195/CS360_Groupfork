...
import { p as useEnterprise, j as useTypedSelector, x as isBaseQueryError } from "./index-mpUnZ0JW.mjs";
...
import { u as useWebhooks } from "./useWebhooks--Y25AHgF.mjs";
...
const WebhookForm = ({
  ...
  const EventTable = useEnterprise(
    EventTableCE,
    async () => (await import("./EventsTable-Bo2-fHbm.mjs")).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-mpI3Zuzs.mjs.map
