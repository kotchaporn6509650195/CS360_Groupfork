...
const AuthPage = ({ hasAdmin }) => {
  ...
  const Login$1 = useEnterprise(
    Login,
    async () => (await Promise.resolve().then(() => require("./Login-0QoPMXS2.js"))).LoginEE
  );
  const forms = useEnterprise(
    FORMS,
    async () => (await Promise.resolve().then(() => require("./constants-dPCwubw_.js"))).FORMS,
    {
...
const AuthenticatedApp = React__namespace.lazy(
  () => Promise.resolve().then(() => require("./AuthenticatedApp-UI_tEhAn.js")).then((n) => n.AuthenticatedApp).then((mod) => ({ default: mod.AuthenticatedApp }))
);
const App$2 = ({ authLogo, menuLogo, showReleaseNotification, showTutorials }) => {
  const adminPermissions = useEnterprise(
    ADMIN_PERMISSIONS_CE,
    async () => (await Promise.resolve().then(() => require("./constants-OeNXdbbb.js"))).ADMIN_PERMISSIONS_EE,
    {
  ...
  const routes = useEnterprise(
    ROUTES_CE,
    async () => (await Promise.resolve().then(() => require("./constants-OeNXdbbb.js"))).ROUTES_EE,
    {
      defaultValue: []
    }
  );
...
const EditViewPage = ({
  ...
  const Information2 = useEnterprise(
    InformationBoxCE,
    async () => (await Promise.resolve().then(() => require("./InformationBoxEE-k4-EeIU1.js"))).InformationBoxEE
  );
  useOnce(() => {
...
const ListViewPage = ({
  ...
  const reviewWorkflowColumns = useEnterprise(
    ...
    async () => (await Promise.resolve().then(() => require("./constants-XnIVjo98.js"))).REVIEW_WORKFLOW_COLUMNS_EE,
    {
  ...
  const ReviewWorkflowsColumns = useEnterprise(
    ...
    async () => {
      const { ReviewWorkflowsStageEE, ReviewWorkflowsAssigneeEE } = await Promise.resolve().then(() => require("./ReviewWorkflowsColumn-6d6Jeo7X.js"));
  ...
  const reviewWorkflowFilter = useEnterprise(
    ...
    async () => (await Promise.resolve().then(() => require("./constants-XnIVjo98.js"))).REVIEW_WORKFLOW_FILTERS,
    {
...
//# sourceMappingURL=index-XLCsX2ry.js.map
